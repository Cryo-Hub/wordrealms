...
export const en: Record<string, string> = {
  ...
  'building.hut.desc': 'Humble dwelling',
  'building.well.name': 'Well',
  'building.well.desc': 'Fresh water',
  'building.tower.name': 'Tower',
  'building.tower.desc': 'Watch the realm',
  'building.market.name': 'Market',
  'building.market.desc': 'Trade hub',
  'building.castle.name': 'Castle',
  'building.castle.desc': 'Seat of power',
